...
namespace PluginKirsanovFotoHorizontal
{
    ...
    public class Plugin : IPlugin  // <-- See how we inherited the IPlugin interface?
    {
        public Plugin()
        {
            ...
            SizesList.Add(new ListSizes() { Id = 1, Name = "Фото", SizeX = 1220, SizeY = 1800 });
        }

        //Declarations of all our internal plugin variables
        string myName = "Фото (горизонтальное)";
        string myDescription = "Модуль новости фото с горизонтальныи расположением.";
