...
namespace Plugin1D
{
	...
	public class Plugin : IPlugin  // <-- See how we inherited the IPlugin interface?
	{
		public Plugin()
		{
            ...
            SizesList.Add(new ListSizes() { Id = 1, Name = "Главное изображение", SizeX = 1600, SizeY = 1800 });
            SizesList.Add(new ListSizes() { Id = 2, Name = "Второе изображение", SizeX = 1000, SizeY = 1000 });
        }
		
		//Declarations of all our internal plugin variables
		string myName = "Default 1 Image";
		string myDescription = "Тестовый модуль с 1 изображением и 2 текстовыми полями.";
		string myAuthor = "Максим Отрохов";
		string myVersion = "1.0.0";
		bool myEditor = true;
		string feed = "Описание 2";
