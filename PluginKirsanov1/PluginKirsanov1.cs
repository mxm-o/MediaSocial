...
namespace Plugin1D
{
    ...
    public class Plugin : IPlugin  // <-- See how we inherited the IPlugin interface?
    {
        public Plugin()
        {
            ...
            SizesList.Add(new ListSizes() { Id = 1, Name = "Фото новости", SizeX = 1800, SizeY = 1800 });
        }

        //Declarations of all our internal plugin variables
        string myName = "Новость с заголовком";
        string myDescription = "Модуль новости с заголовком и фото.";
